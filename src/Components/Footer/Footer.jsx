      ...
      <div className="container">
        <div className="footer_box">
          ...
          <div className="footer_card2">
            <div>
            <iframe className="map_container" src="https://yandex.com/map-widget/v1/?um=constructor%3Ae8e1e40390be0346f4600a898da9c7fa8f33c60b5e0d947434b36c03c94dd734&amp;source=constructor"  frameborder="0"></iframe>
            </div>
          </div>
